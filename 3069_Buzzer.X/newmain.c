 ...
 *
 * Created on 28 March, 2025, 10:26 AM
 */


//Expt.2: Buzzer ON and OFF using Timer0 Interrupt
...
while(1); //Program execution stays here until the timer overflow interrupt is generate
}
